...
exports.getDCComics = (page) => {

    return new Promise((resolve, reject) => {

        axios(`${DC.dcHome}/${page}`).then(response => {
...
exports.getDCComicsVertigo = (page) => {

    return new Promise((resolve, reject) => {

        axios(`${DC.dcVertigo}/${page}`).then(response => {
            const html = response.data;
            const $ = cheerio.load(html);
...
exports.getDCComicsWildstorm = (page) => {

    return new Promise((resolve, reject) => {

        axios(`${DC.dcWildstorm}/${page}`).then(response => {
            const html = response.data;
            const $ = cheerio.load(html);
